...
function JSXExamples() {
    ...
    const user = {
        ...
        lastName: 'มาเสม',
        age: 22,
        hobbies: ['เล่นเกม', 'อ่านการ์ตูน', 'ฟังเพลง']
    };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'กำไล', price: 25000, inStock: true },
                        { id: 2, name: 'กำไม', price: 590, inStock: true },
                        { id: 3, name: 'กำทำไม', price: 1290, inStock: false }
                    ].map(product => (
